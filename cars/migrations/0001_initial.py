# Generated by Django 4.2.20 on 2025-04-07 00:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cars.utilisateur')),
                ('voiture', models.ForeignKey(default=cars.models.get_first_voiture_vendu, on_delete=django.db.models.deletion.CASCADE, to='cars.voiturevendu')),
            ],
        ),
        migrations.AddField(
